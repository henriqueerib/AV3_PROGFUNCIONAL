defmodule RotinaecoWeb.UserLive.Settings do
  use RotinaecoWeb, :live_view

  on_mount {RotinaecoWeb.UserAuth, :require_sudo_mode}
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-xl mx-auto space-y-6">
        <h1 class="text-2xl font-bold text-gray-800">Configurações da Conta</h1>

        <div class="bg-white rounded-lg shadow p-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-4">Alterar E-mail</h2>
          <.form
            for={@email_form}
            id="email_form"
