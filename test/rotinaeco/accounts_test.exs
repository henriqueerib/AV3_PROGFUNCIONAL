defmodule Rotinaeco.AccountsTest do
  use Rotinaeco.DataCase

  alias Rotinaeco.Accounts

  import Rotinaeco.AccountsFixtures
  alias Rotinaeco.Accounts.{User, UserToken}
  ...
  describe "update_user_password/2" do
    ...
    test "validates password", %{user: user} do
      ...
      assert Enum.any?(errors_on(changeset).password, &String.contains?(&1, "6"))
    end
    ...
    test "validates maximum values for password for security", %{user: user} do
      ...
      assert Enum.any?(errors_on(changeset).password, &String.contains?(&1, "72"))
    end
